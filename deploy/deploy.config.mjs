...
export const deployConfig = {
  ...
  targets: {
    ...
    backend: {
      ...
      remoteCommands: [
        "cd /www/wwwroot/biz-cancellation/backend && npm install --ignore-scripts",
        "cd /www/wwwroot/biz-cancellation/backend && npx prisma generate",
        "cd /www/wwwroot/biz-cancellation/backend && npx prisma migrate deploy",
